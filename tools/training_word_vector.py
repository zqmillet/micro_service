...
def parse_argument():
    ...
    arguments.add_argument('-d', '--corpus_directory',
                           action = 'store',
                           type = str,
                           required = True,
    ...
    arguments.add_argument('-k', '--placeholder',
                           action = 'store',
                           type = str,
                           default = 'UNK',
